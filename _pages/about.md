...
I am joining the Agricultural and Food Economics Group at the Department of Economics, SLU (Swedish University of Agricultural Sciences), Sweden, as an Assistant Professor on the 1st of October.
  ...
  <div class="about-col">
    ...
    <ul class="about-list">
      <li>
        ...
        <div>
          <p class="about-item-main">Postdoctoral Researcher, 2022&ndash;2026</p>
          <p class="about-item-sub">Agricultural Economics and Policy Group, ETH Zurich, Switzerland</p>
        </div>
      </li>
      <li>
        <svg class="about-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>
        <div>
          <p class="about-item-main">Postdoctoral Researcher, 2021&ndash;2022</p>
          <p class="about-item-sub">University of Southampton, United Kingdom</p>
        </div>
      </li>
    </ul>
  </div>
