...
<ul class="about-list">
  <li>
    ...
    <div>
      <p class="about-item-main">Postdoctoral Researcher, 2022&ndash;2026 &mdash; <span class="about-item-sub">Agricultural Economics and Policy Group, ETH Zurich, Switzerland</span></p>
    </div>
  </li>
  <li>
    <svg class="about-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>
...
<ul class="about-list">
  <li>
    ...
    <div>
      <p class="about-item-main">Ph.D. in Agricultural Economics, 2021 &mdash; <span class="about-item-sub">University College Dublin, Ireland</span></p>
    </div>
  </li>
  <li>
    <svg class="about-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84 51.39 51.39 0 00-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5m0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5"/></svg>
    <div>
      <p class="about-item-main">M.Sc. in Development Economics, 2016 &mdash; <span class="about-item-sub">Wageningen University &amp; Research, Netherlands</span></p>
    </div>
  </li>
  <li>
    <svg class="about-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84 51.39 51.39 0 00-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5m0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5"/></svg>
    <div>
      <p class="about-item-main">B.Sc. in Agricultural Economics, 2012 &mdash; <span class="about-item-sub">Aristotle University of Thessaloniki, Greece</span></p>
    </div>
  </li>
</ul>
